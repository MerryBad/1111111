...
# path = 'C:/Users/Pc/Downloads/시설 작물 개체 이미지/Training/label/'
#
# # path_label = 'D:/dataset/label/'
# file_List = os.listdir(path)
#
# with open('C:/Users/Pc/Downloads/시설 작물 개체 이미지/Training/test_label.csv', 'w', newline='') as output:
#     f = csv.writer(output)
...
#                 exit()
#
# data = pd.read_csv('C:/Users/Pc/Downloads/시설 작물 개체 이미지/Validation/test_label.csv', header=0, encoding='cp949')
...
#
# print(data['pl_Name'].value_counts())  # 15
# print(data['pl_Type'].value_counts())  # 23
# print(data['pl_Name+Step'].value_counts())  # 50
...
#     count += 1
#     if i in image_List:
#         print(str(count) + '/' + str(len(label_List)))
#         pass
#     else:
#         # print(i)
#         os.remove(path_label + i + ".json")
...
#     #     pass
#     for j in label_List:
#         if path_image + i.upper().strip(".JPG") in path_label+j.upper().strip(".JSON"):
#             break
#         else:
#             print(path_image+i)
